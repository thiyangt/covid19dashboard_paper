...
The rest of the paper is organized as follows: the [Section 2](#litreview) of dashboards created using data related to COVID-19 pandemic. [Section 3](#methods) provides the methodology; [Section 4](#results) presents results; and [Section 5](#conclusion) offers some concluding remarks.
