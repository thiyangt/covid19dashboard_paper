...
When building our dashboard we use a colour-blind friendly theme. Our dashboard is fully reproducible. The source code to reprouduce the results are available in a public GitHub repository and can be accessonline via https://github.com/thiyangt/covid19srilanka
