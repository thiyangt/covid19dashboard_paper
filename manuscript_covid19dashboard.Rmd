...
```{r, echo=FALSE, fig.cap="Screeshot of Panel 1", out.width="80%", fig.align='center'}
knitr::include_graphics("Images/image1.png")
```

```{r, echo=FALSE, fig.cap="Screeshot of Panel 2", out.width="80%", fig.align='center'}
knitr::include_graphics("Images/image2.png")
```

```{r, echo=FALSE, fig.cap="Screeshot of Panel 3", out.width="80%", fig.align='center'}
knitr::include_graphics("Images/image3.png")
```

```{r, echo=FALSE, fig.cap="Screeshot of Panel 4", out.width="80%", fig.align='center'}
knitr::include_graphics("Images/image4.png")
```

```{r, echo=FALSE, fig.cap="Screeshot of Panel 5", out.width="80%", fig.align='center'}
knitr::include_graphics("Images/image5.png")
```

```{r, echo=FALSE, fig.cap="Screeshot of Panel 6", out.width="80%", fig.align='center'}
knitr::include_graphics("Images/image6.png")
```

```{r, echo=FALSE, fig.cap="Screeshot of Panel 7", out.width="80%", fig.align='center'}
knitr::include_graphics("Images/image7.png")
```

```{r, echo=FALSE, fig.cap="Screeshot of Panel 8", out.width="80%", fig.align='center'}
