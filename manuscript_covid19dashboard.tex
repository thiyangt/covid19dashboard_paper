...
\subsection{Summary of data representation on
...
In this study, we have daily COVID-19 data related to deaths, recovered
and confirmed cases in all 25 districts in Sri Lanka. This structure
generates a multiple time series collection. Visualizing these time
series data is useful to identify similarities and dissimilarities
between districts and their general trends. There are two approaches to
visualizing these time series: (i) drawing individual time series plots
for each district, and (ii) simultaneously plots all time series on a
single panel. Plotting separate panels for each district is not
effective. The reason is that it is hard to compare across 25 different
panels at once. Plotting all time series simultaneously is also not
possible due to overlapping time series and scale differences. We use
heatmaps ~to visualize global and local similarities and dissimilarities
across districts (Peng (2008)) along with Tree Maps, Choropleth Maps,
and ~Dorling Cartogram. The cumulative number of confirmed deaths, and
confirmed cases (both on log scale and linear scale) were used to
compare the status of Sri Lanka against the top-10 countries affected by
COVID-19. Furthermore, we use color-blind friendly colour palettes for
the graphics. To represent qualitative data, a diverging colour palette
was used, and to represent numeric variables, a sequential colour theme
was used. Table 5 provides an overview of methods that have been used to
visualize data.
...
\caption{Distribution of COVID19 Cases by Districts Plotted on a Single
Panel}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.42in]{Images/1} \caption{Johns Hopkins University COVID-19 Dashboard}\label{fig:unnamed-chunk-6}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.35in]{Images/2} \caption{WHO COVID-19 Dashboard}\label{fig:unnamed-chunk-7}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.42in]{Images/3} \caption{COVID-19 Surveillance Dashboard}\label{fig:unnamed-chunk-8}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.39in]{Images/4} \caption{Corona cases per Municipality in Belgium Dashboard}\label{fig:unnamed-chunk-9}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.46in]{Images/5} \caption{COVID-19 dashboard for England}\label{fig:unnamed-chunk-10}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.47in]{Images/6} \caption{New Zealand COVID-19 Dashboard}\label{fig:unnamed-chunk-11}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.33in]{Images/7} \caption{COVID-19 Dashboard for Pakistan}\label{fig:unnamed-chunk-12}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.47in]{Images/8} \caption{COVID-19 in Canada dashboard}\label{fig:unnamed-chunk-13}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.42in]{Images/9} \caption{India COVID-19 Dashboard}\label{fig:unnamed-chunk-14}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.12in]{Images/10} \caption{Italy COVID-19 Dashboard}\label{fig:unnamed-chunk-15}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.35in]{Images/11} \caption{Jamaica COVID-19 Dashboard}\label{fig:unnamed-chunk-16}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.25in]{Images/12} \caption{GCI COVID-19 Dashboard for Russia}\label{fig:unnamed-chunk-17}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.4in]{Images/13} \caption{COVID-19 Live Situational Analysis Dashboard of Sri Lanka}\label{fig:unnamed-chunk-18}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.46in]{Images/14} \caption{COVID 19 ZA South Africa Dashboard}\label{fig:unnamed-chunk-19}
\end{figure}
...
\begin{figure}
\includegraphics[width=8.33in]{Images/15} \caption{Robert Koch-Institute COVID-19 dashboard for German}\label{fig:unnamed-chunk-20}
\end{figure}
