...
\caption{Screeshot of Panel 1}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Screeshot of Panel 2}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Screeshot of Panel 3}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Screeshot of Panel 4}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption{Screeshot of Panel 5}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{Screeshot of Panel 6}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Screeshot of Panel 7}\label{fig:unnamed-chunk-11}
\end{figure}
...
\caption{Screeshot of Panel 8}\label{fig:unnamed-chunk-12}
\end{figure}
