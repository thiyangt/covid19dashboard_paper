...
corresponds to number of death cases, number of reported cases, number
of recovered cases and COVID-19 vaccinated counts in Sri Lanka. The data
are made available through an open-source R package covid19srilanka
(Talagala 2021).
...
\textbf{Table 05: Description of the panels}
